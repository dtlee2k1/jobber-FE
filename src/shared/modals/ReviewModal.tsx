...
import { useAddReviewMutation } from 'src/services/review.service'
...
export default function ReviewModal({ order, type, onClose }: IReviewModalProps) {
        ...
        <div className="relative bottom-auto left-auto right-auto top-auto max-h-[90vh] min-w-[500px] bg-white p-4 text-[#404145]">
          ...
          <div className="mb-5 text-base">
            <TextAreaInput
              ...
              name="review"
              placeholder="Please share your review for the product"
              value={review}
              rows={4}
              onChange={(e) => {
