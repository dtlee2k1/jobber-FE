...
export default function OfferModal({ header, gigTitle, authUser, receiver, singleMessage, cancelBtnHandler }: IOfferModalProps) {
  ...
  return (
    <ModalBg>
      <div className="fixed bottom-0 left-0 right-0 top-0 flex w-full items-center justify-center">
        <div className="relative bottom-auto left-auto right-auto top-[8%] max-h-[90vh] min-w-[500px] bg-white p-4">
              ...
              <div className="relative mb-5 mt-2">
                <TextInput
                  ...
                  onChange={(e) => {
                    ...
                    setOffer({ ...offer, price: parseInt(priceValue) > 0 ? priceValue : '0' })
                  }}
