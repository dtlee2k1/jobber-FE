...
import { ISettings } from 'src/interfaces/header.interface'
...
interface IHomeHeaderSideBarProps {
  setOpenSidebar?: Dispatch<SetStateAction<boolean>>
}

export default function HomeHeaderSideBar({ setOpenSidebar }: IHomeHeaderSideBarProps) {
  ...
  return (
    <div
      className={'fixed left-0 top-0 z-[150] flex h-screen w-full bg-black/40 transition-all duration-500 lg:hidden'}
      onClick={() => {
        if (setOpenSidebar) {
