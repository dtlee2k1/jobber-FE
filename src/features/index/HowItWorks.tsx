      ...
      <div className="px-4 py-8 sm:py-16 lg:px-6">
        ...
        <div className="space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-4">
          <div className="text-center">
            ...
            <h3 className="mb-2 text-base font-bold lg:text-xl dark:text-sky-400">Create an account</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="mb-2 text-base font-bold lg:text-xl dark:text-sky-400">Browse Experts</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="mb-2 text-base font-bold lg:text-xl dark:text-sky-400">Contact Experts</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="mb-2 text-base font-bold lg:text-xl dark:text-sky-400">Collaborate</h3>
