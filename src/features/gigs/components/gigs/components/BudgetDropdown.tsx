                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <TextInput
                      ...
                      onChange={(e) =>
                        setSelectedBudget({ ...selectedBudget, minPrice: parseInt(e.target.value) > 0 ? e.target.value : '0' })
                      }
                      onKeyDown={(e) => {
                  ...
                  <div>
                    ...
                    <TextInput
                      ...
                      onChange={(e) =>
                        setSelectedBudget({ ...selectedBudget, maxPrice: parseInt(e.target.value) > 0 ? e.target.value : '0' })
                      }
                      onKeyDown={(e) => {
                        if (e.key !== 'Backspace' && isNaN(parseInt(e.key))) {
                          e.preventDefault()
