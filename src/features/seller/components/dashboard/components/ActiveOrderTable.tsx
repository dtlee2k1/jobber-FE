...
export default function ActiveOrderTable({ activeOrders }: IActiveOrderProps) {
            ...
            <tbody className="flex-1 sm:flex-none">
              {activeOrders.map((order: IOrderDocument) => (
                ...
                >
                  ...
                  <td className="p-3 text-left lg:text-center">{dayMonthYear(`${order.offer.newDeliveryDate}`)}</td>
