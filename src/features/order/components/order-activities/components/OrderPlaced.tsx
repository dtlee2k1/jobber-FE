        ...
        <div className="flex gap-4">
          ...
          <div className="w-full">
            <div className="border-grey mt-2 flex items-center gap-2 border-b pb-6 text-gray-500">
              ...
              <p className="text-sm font-normal italic">{dayWithTime(`${order?.events.placeOrder}`)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-4 pt-4">
          ...
          <div className="w-full">
            <div className="border-grey mt-2 flex items-center gap-2 border-b pb-6 text-gray-500">
              ...
              <p className="text-sm font-normal italic">{dayWithTime(`${order?.events.orderStarted}`)}</p>
            </div>
          </div>
        </div>
        <div className="flex gap-4 pt-4">
          ...
          <div className="w-full">
            <div className="border-grey mt-2 flex items-center gap-2 border-b pb-6 text-gray-500">
              ...
              <p className="text-sm font-normal italic">{dayWithTime(`${order?.offer.newDeliveryDate}`)}</p>
            </div>
          </div>
        </div>
      </div>
