...
import { IOrderDocument, IOrderReviewModal } from 'src/interfaces/order.interface'
    ...
    <>
      {orderReviewModal.buyerReview && (
        <ReviewModal
          ...
          onClose={() => setOrderReviewModal({ ...orderReviewModal, buyerReview: false })}
        />
      )}
      {orderReviewModal.sellerReview && (
        <ReviewModal
          type="seller-review"
          order={order as IOrderDocument}
          onClose={() => setOrderReviewModal({ ...orderReviewModal, sellerReview: false })}
        />
      )}
              ...
              <div className="border-grey w-full cursor-pointer border-b pb-6">
                <div className="mt-2 flex items-center justify-between font-medium text-gray-500">
                  <div className="flex gap-2">
                    ...
                    <p className="flex self-center text-sm font-normal italic">{dayWithTime(`${order?.events.buyerReview}`)}</p>
                  </div>
              ...
              <div className="w-full cursor-pointer pb-6">
                <div className="mt-2 flex items-center justify-between font-medium text-gray-500">
                  <div className="flex gap-2">
                    ...
                    <p className="flex self-center text-sm font-normal italic">{dayWithTime(`${order?.events.sellerReview}`)}</p>
                  </div>
